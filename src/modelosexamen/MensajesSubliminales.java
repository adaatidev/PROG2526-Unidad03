...
public class MensajesSubliminales {
	...
	public static String[] crearMensajesIniciales() {
		return new String[] { "LA NIEBLA CUBRE EL PUENTE", "NO MIRES DETRAS DE LA PUERTA",
	...
	/**
	 * Lee un número entero por teclado, repitiendo la petición mientras el usuario
	 * no introduzca un entero válido.
	 *
	 * @param scanner objeto para leer por teclado
	...
	/**
	 * Cuenta cuántas veces aparece una letra dentro de un mensaje, sin distinguir
	...
	/**
	 * Extrae el mensaje oculto formado por los caracteres en posiciones pares del
	...
	/**
	 * Cuenta cuántos mensajes contienen una palabra concreta, sin distinguir
	 * mayúsculas de minúsculas.
	 *
	 * @param mensajes array de mensajes
	...
	/**
	 * Devuelve la palabra más larga de un mensaje. Si hay empate, se devuelve la
	 * primera.
	 *
	...
	/**
	 * Comprueba si un mensaje supera la longitud mínima establecida cuando se
